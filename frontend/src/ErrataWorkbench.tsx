  ...
  return (
    <main className="grid min-h-[calc(100vh-65px)] grid-cols-[minmax(0,1fr)] bg-white lg:grid-cols-[280px_minmax(0,1fr)]">
      ...
      {selected && <section className={`${mobileListOpen ? 'hidden' : 'block'} min-w-0 px-4 py-5 lg:block sm:px-6 lg:px-8 lg:py-7`}>
        ...
        <div className="grid min-w-0 grid-cols-[minmax(0,1fr)] gap-8 pt-6 xl:grid-cols-[minmax(0,1fr)_minmax(360px,0.8fr)]">
          ...
          <div className="min-w-0 h-fit border-t border-slate-200 pt-6 xl:sticky xl:top-6 xl:border-l xl:border-t-0 xl:pl-8 xl:pt-0">
